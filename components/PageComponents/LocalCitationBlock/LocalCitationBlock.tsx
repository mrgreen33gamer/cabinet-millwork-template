...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'Craftline Cabinetry & Millwork',
  address       = '2200 S University Parks Dr, Waco, TX 76706',
  phone         = '(254) 741-2800',
  email         = 'hello@craftlinecabinetry.com',
  googleMapsUrl = 'https://maps.google.com/?q=Craftline+Cabinetry+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with custom cabinets and fine millwork.
          </p>
        </div>
