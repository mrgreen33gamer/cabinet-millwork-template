...
const INDUSTRIES = [
  { slug: 'homebuilders-developers', label: 'Homebuilders & Developers', icon: faHardHat },
  { slug: 'interior-designers',      label: 'Interior Designers',        icon: faDraftingCompass },
  { slug: 'commercial-hospitality',  label: 'Commercial & Hospitality',  icon: faHotel },
];
...
export default function SectionIndustriesServed({
  ...
  subtitle = 'Cabinetry and millwork programs built for how your organization actually works.',
  disableLinks = false,
