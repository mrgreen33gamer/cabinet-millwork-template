        ...
        <div className={styles.storyBody}>
          <div className={styles.storyPull}>
            <p className={styles.pullQuote}>
              &quot;We started Heritage because we were tired of watching homeowners get pressured into cabinets they didn&apos;t need — or shoddy installs that failed in a year.&quot;
            </p>
            <div className={styles.pullAttrib}>
              <span className={styles.pullName}>— Elena Vargas</span>
              <span className={styles.pullTitle}>Founder, Craftline &amp; Tile Co.</span>
            </div>
          </div>

          <div className={styles.storyText}>
            <p className={styles.storyParagraph}>
              Founded in 2008 in Waco, TX, Craftline &amp; Tile Co. started with one crew and one principle:
            ...
            <div className={styles.milestones}>
              {[
                ...
                { year: '2019', label: '1,000 cabinets installed' },
                { year: '2025', label: '1,800+ cabinets installed' },
              ].map((m, i) => (
