...
const SERVICE_CTAS = [
  {
    ...
    headline: 'Ready for shop-built custom cabinets?',
    body: 'Kitchen and bath cabinets fabricated in our Waco shop — flat-rate quote before fabrication starts.',
  ...
  },
  {
    key: 'kitchen-remodel',
    icon: faBath,
    eyebrow: 'Kitchen Remodel Millwork',
    headline: 'Planning a kitchen remodel?',
    body: 'Cabinets, islands, pantries, and trim coordinated as one millwork package.',
    cta: 'Start a Remodel',
    href: '/services/kitchen-remodel-millwork',
    accent: 'obsidian' as const,
  },
  {
    key: 'closets',
    icon: faDraftingCompass,
    eyebrow: 'Closet & Built-Ins',
    headline: 'Need storage that actually fits?',
    body: 'Walk-ins, mudrooms, media walls, and office built-ins measured and built for how you live.',
    cta: 'Explore Built-Ins',
    href: '/services/closet-built-ins',
    accent: 'green' as const,
  },
  {
    key: 'commercial',
    icon: faBuilding,
    eyebrow: 'Commercial Millwork',
    headline: 'Planning commercial casework?',
    body: 'Reception desks, display fixtures, and tenant millwork delivered on your opening date.',
    cta: 'Talk to Our Team',
    href: '/services/commercial-millwork',
    accent: 'obsidian' as const,
  },
];
