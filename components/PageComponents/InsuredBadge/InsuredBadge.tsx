...
const COVERAGES = [
  ...
  },
  {
    icon: faBriefcase,
    title: 'Custom Shop',
    detail: 'Cabinets and millwork built in our Waco shop',
  },
  {
    icon: faFileContract,
    ...
    return (
      <div className={styles.inlineBadge}>
        ...
        <span className={styles.inlineText}>
          Licensed Contractor · Fully Insured · Custom Shop
        </span>
      </div>
    );
  }
        ...
        >
          ...
          <div className={styles.headerText}>
            ...
            <p className={styles.subtitle}>
              ...
              contractor, and our 5-Year Craftsmanship Warranty. You get peace of mind —
