...
export default function NearbyAreasHero({
  ...
  const displayHeadline = headline ?? `Cabinetry Service in ${cityName}, TX`;
  const displayDesc     = description ??
    `Craftline Cabinetry & Millwork provides custom cabinets and fine millwork to ${cityName} and all surrounding communities. Licensed contractor, flat-rate quotes, 5-Year Craftsmanship Warranty.`;
    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <a href="tel:+12547412800" className={styles.phoneBtn}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
