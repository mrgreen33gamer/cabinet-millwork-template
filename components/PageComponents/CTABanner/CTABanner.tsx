...
export default function CTABanner({
  ...
  spot = "CTABanner",
  imageSrc,
  eyebrow = "Craftline · Central Texas",
  badgeA = "Samples",
  badgeB = "Custom",
  badgeC = "Install Crew",
}: CTABannerProps) {
  ...
  return (
    <section className={styles.banner} aria-label="Call to action">
      ...
      <motion.div
        ...
        aria-hidden="true"
      >
        <svg width="400" height="400" viewBox="0 0 24 24" fill="currentColor"><path d="M4 4h16v3H4V4zm0 5h16v3H4V9zm0 5h16v3H4v-3zm0 5h16v2H4v-2z" opacity="0.75"/></svg>
      </motion.div>
