...
const DEFAULT_ROWS: ComparisonRow[] = [
  { feature: 'Flat-rate quote before fabrication',     us: true,  others: false },
  { feature: '5-Year craftsmanship warranty',          us: true,  others: false },
  { feature: 'Shop-built custom cabinetry',            us: true,  others: 'Sometimes' },
  ...
  { feature: 'Free design consultation',               us: true,  others: false },
  { feature: 'Residential & commercial millwork',      us: true,  others: 'Sometimes' },
...
export default function ValueComparison({ rows = DEFAULT_ROWS, title = 'Craftline vs. The Other Guys' }: ValueComparisonProps) {
  return (
