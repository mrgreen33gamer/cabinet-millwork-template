...
// Craftline Cabinetry & Millwork — Contact Page (unique build, not just a form import)
...
// ── Service options ────────────────────────────────────────────────────────────
const SERVICES = [
  'Custom Cabinets', 'Kitchen Millwork', 'Bathroom Vanities',
  'Cabinet Refacing', 'Commercial Millwork', 'Closet & Built-Ins',
  'Other / Not Sure',
];
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 741-2800 or fill out the form below. We respond to most requests within one business day and can usually schedule an on-site measure within the week.",
  },
  {
  ...
  },
  {
    ...
    answer: 'No — design consultations are always free, with no obligation to book. We measure, show samples, and leave you with a firm written price.',
  },
  {
    question: 'Do you handle commercial millwork projects?',
  ...
  {
    question: 'How do I know if I need a reface or a full replacement?',
    answer: "Our installer will tell you honestly after the assessment. If repair or refinish will restore the cabinets, we recommend that first — full replacement only when it makes sense. We'll always show you the numbers and let you decide.",
  },
];
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroInner}>
          ...
          <motion.h1 className={styles.heroTitle}
            ...
            Let&apos;s Get Your<br />
            <span className={styles.heroAccent}>Custom Cabinets</span>
          </motion.h1>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@craftlinecabinetry.com',
                  href:      'mailto:hello@craftlinecabinetry.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '2200 S University Parks Dr, Waco TX 76706',
                  href:      'https://maps.google.com/?q=2200+S+University+Parks+Dr+Waco+TX+76706',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose Craftline</p>
              {[
                'Flat-rate pricing — written quote before we start',
                '5-Year Craftsmanship Warranty on every install',
                'shop-built, licensed installers only',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A Craftline specialist will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12547412800">(254) 741-2800</a>.
                  </p>
                ...
                <motion.div key="form" className={styles.formCard}
                  ...
                  <div className={styles.formCardHeader}>
                    ...
                    <div>
                      <h2 className={styles.formTitle}>Request a Free Design Consultation</h2>
      ...
      <CTABanner
        ...
        subline="Call (254) 741-2800 — free design consultations, flat-rate pricing, 5-Year Craftsmanship Warranty."
