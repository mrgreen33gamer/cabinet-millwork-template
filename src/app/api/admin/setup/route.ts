...
const SITE_URL    = process.env.NEXT_PUBLIC_SITE_URL ?? 'https://www.craftlinecabinetry.com';
const BRAND_NAME  = process.env.NEXT_PUBLIC_BRAND_NAME ?? 'Craftline Cabinetry & Millwork';
