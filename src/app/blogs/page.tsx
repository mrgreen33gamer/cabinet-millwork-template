    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>Craftline Cabinetry &amp; Millwork — Blog Center</h1>
          <p className={styles.pageSubtitle}>
            Real talk and useful tips for Central Texas homeowners — custom vs semi-custom cabinets, materials for Central Texas, and when to reface or replace.
          </p>
        </motion.div>
      </section>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Need custom cabinetry in Central Texas?
            </p>
            <p className={styles.blogCTABody}>
              We&apos;ve been building custom cabinets for Waco-area homes and businesses since 2008. Free in-home estimate, no obligations.
            </p>
