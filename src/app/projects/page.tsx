...
export default function ProjectsPage() {
  return (
    <main className={styles.pageWrapper}>
      <SectionIntro
        title="Our Projects"
        subtitle="Custom cabinets and fine millwork for Central Texas homes and businesses — see what's possible for your space"
      />

      {beforeAfterItems.length > 0 && (
        <div className={styles.section}>
          <BeforeAfter
            title="Real Kitchens. Real Results."
      ...
      <div className={styles.section}>
        <ProjectCardGrid
          ...
          subtitle="Custom kitchens, vanities, closets, commercial millwork, and refacing across Central Texas — click any card for the full story"
        />
      </div>
